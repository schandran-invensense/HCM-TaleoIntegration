...
public class F_PERSON_EMAIL_VO {
	...
	private String MASTERED_IN_LDAP_FLAG;
	...
	public F_PERSON_EMAIL_VO() {

	}

	public F_PERSON_EMAIL_VO(String eMAIL_ADDRESS_ID, String bUSINESS_GROUP_ID, String pERSON_ID, String dATE_FROM,
			String dATE_TO, String eMAIL_TYPE, String eMAIL_ADDRESS, String mASTERED_IN_LDAP_FLAG,
			String pRIMARY_FLAG) {
		super();
		...
		MASTERED_IN_LDAP_FLAG = mASTERED_IN_LDAP_FLAG;
	...
	public String toDelimitedString() {
		return EMAIL_ADDRESS_ID + "|" + BUSINESS_GROUP_ID + "|" + PERSON_ID + "|" + DATE_FROM + "|" + DATE_TO
				+ "|" + EMAIL_TYPE + "|" + EMAIL_ADDRESS + "|" + PRIMARY_FLAG + "|" + MASTERED_IN_LDAP_FLAG + "|"
	...
	public String getMASTERED_IN_LDAP_FLAG() {
		return MASTERED_IN_LDAP_FLAG;
	}

	public void setMASTERED_IN_LDAP_FLAG(String mASTERED_IN_LDAP_FLAG) {
		MASTERED_IN_LDAP_FLAG = mASTERED_IN_LDAP_FLAG;
	}
