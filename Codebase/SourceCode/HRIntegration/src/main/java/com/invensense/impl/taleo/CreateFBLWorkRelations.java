...
public class CreateFBLWorkRelations {
	...
	public static void createAssignmentFile(File pFolder, HCMTaleoEmployee hcmTaleoEmployee) {
		try {
			...
			wAssign_VO.setACTION_CODE("HIRE");
			wAssign_VO.setASSIGNMENT_ID(createAssignmentId(hcmTaleoEmployee.getEmployeeId()));
			//wAssign_VO.setASSIGNMENT_ID(hcmTaleoEmployee.getHcmPersonId());
			...
			//wAssign_VO.setASSIGNMENT_NUMBER(hcmTaleoEmployee.getHcmPersonId());			
			...
			wAssign_VO.setASSIGNMENT_TYPE("E");
...
wAssign_VO.setPROJECTED_START_DATE(hcmTaleoEmployee.getProjStartDate());
			...
			wAssign_VO.setPERSON_ID(hcmTaleoEmployee.getFblPersonId());
			//wAssign_VO.setPERSON_TYPE_ID(CreateEmployeeConstants.getCreatePersonTypeId());
			wAssign_VO.setPERSON_TYPE_ID("16AA90408B3C4F84E0532E90C10AF7C4");
			...
			wAssign_VO.setSYSTEM_PERSON_TYPE("EMP");
	...
	private static void createWorkRelationshipFile(File wFolder, HCMTaleoEmployee hcmTaleoEmployee) {
		...
		//	fWork_Relations_VO.setDATE_START("2017-01-20");
			...
			fWork_Relations_VO.setPERSON_ID(hcmTaleoEmployee.getFblPersonId());
			...
			fWork_Relations_VO.setPERIOD_TYPE("E");
			out.write("\r\n");
...

	{
		...
		try {
			...
			fWork_Terms_VO.setACTION_CODE("HIRE");
		...
		//Added new
			...
			fWork_Terms_VO.setASSIGNMENT_TYPE("ET");
	...
	//		fWork_Terms_VO.setBUSINESS_UNIT_ID(CreateEmployeeConstants.getCreateBusinessUnitId());
		fWork_Terms_VO.setBUSINESS_UNIT_ID(hcmTaleoEmployee.getHcmBusinessUnit());
			...
			fWork_Terms_VO.setPERSON_ID(hcmTaleoEmployee.getFblPersonId());
