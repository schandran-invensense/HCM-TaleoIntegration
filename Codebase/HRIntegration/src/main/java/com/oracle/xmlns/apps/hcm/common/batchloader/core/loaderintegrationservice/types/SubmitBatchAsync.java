 ...
 *         &lt;element name="BusinessObjectList" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "submitBatchAsync")
public class SubmitBatchAsync {

    @XmlElement(name = "ZipFileName", required = true)
    protected String zipFileName;
    @XmlElement(name = "BusinessObjectList")
